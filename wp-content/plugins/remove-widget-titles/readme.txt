...
== Description ==
The [Remove Widget Titles](http://scratch99.com/wordpress/plugins/remove-widget-titles/) plugin removes the title from any widget that has a title starting with the "!" character.
...
= Acknowledgements =
This plugin was written for [QPS Media](http://twitter.com/#!/qpsmedia), part of the [Queensland Police Service](http://www.police.qld.gov.au/), who have allowed me to release to the WordPress community.
